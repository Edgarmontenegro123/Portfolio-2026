            ...
            <div className='max-w-6xl mx-auto'>
                ...
                <div className='grid gap-12 lg:grid-cols-2 items-start'>
                    <div className='flex flex-col gap-5 bg-brand-text/5 p-6 rounded-2xl border border-brand-text/10'>
                        ...
                        >
                            <svg className='w-6 h-6 text-green-500 animate-pulse' viewBox='0 0 24 24' fill='currentColor'>
                        ...
                        <a
                            ...
                            className='flex items-center gap-4 p-3 rounded-xl hover:bg-brand-text/5 text-brand-text transition-colors duration-200'
                        >
                            <svg className='w-6 h-6 text-brand-text' viewBox='0 0 24 24' fill='currentColor'>
                        ...
                        <a
                            ...
                            className='flex items-center gap-4 p-3 rounded-xl hover:bg-brand-text/5 text-brand-text transition-colors duration-200'
                        >
                            <svg className='w-5 h-5 mx-0.5 text-brand-text' viewBox='0 0 24 24' fill='currentColor'>
                        ...
                        <a
                            ...
                            target='_blank'
                            rel='noopener noreferrer'
                            className='flex items-center gap-4 p-3 rounded-xl bg-brand-primary/10 text-brand-primary hover:bg-brand-primary/20 transition-colors duration-200 font-semibold'
                        >
                    ...
                    >
                        ...
                        <div className='flex flex-col gap-1.5'>
                            ...
                            <input
                                ...
                                className='w-full px-4 py-2.5 rounded-xl border border-brand-text/10 bg-brand-text/5 text-brand-text focus:outline-none focus:border-brand-primary transition-colors disabled:opacity-50 text-sm'
                        ...
                        <div className='flex flex-col gap-1.5'>
                            ...
                            <textarea
                                ...
                                className='w-full px-4 py-2.5 rounded-xl border border-brand-text/10 bg-brand-text/5 text-brand-text focus:outline-none focus:border-brand-primary transition-colors disabled:opacity-50 resize-none text-sm'
